...
/*   Updated: 2022/11/14 10:49:32 by mrehberg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (window -> map[window -> player_pos_y + 1]
		[window -> player_pos_x] == '0'
		|| window -> map[window -> player_pos_y + 1]
		[window -> player_pos_x] == 'C')
	{
	...
	else if (window -> map[window -> player_pos_y + 1]
		[window -> player_pos_x] == 'E' && is_c_in_map(window) == 0)
	{
...
{
	if (window -> map[window -> player_pos_y]
		[window -> player_pos_x - 1] == '0'
		|| window -> map[window -> player_pos_y]
		[window -> player_pos_x - 1] == 'C')
	{
		window -> map[window -> player_pos_y][window -> player_pos_x] = '0';
	...
	else if (window -> map[window -> player_pos_y]
		[window -> player_pos_x - 1] == 'E' && is_c_in_map(window) == 0)
	{
		ft_printf("You are the Flunkyball champion\n");
		close_game(window);
	}
