...
/*   Updated: 2022/11/08 10:55:01 by mrehberg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief split a string by a char you give the function
 * i.e. char *test = "    hallo       du    ";
 * rtn = ft_split(test, ' ');
 * 
 * @param s 
 * @param c 
 * @return 2 d char array, dont forget to free
 */
